...
**0.3.4 integrity-closure verification:** implementation and regression coverage are on `fix/0.3.4-integrity-closure`; final branch CI / PR / merge verification will be recorded here before deployment.  
