...
**0.3.4 Tape rule:** Large/Whale values remain dollar-notional trade-size proxies. Current-method reconciled consolidated-SIP samples remain visible in charts/tables even when partial; sampled notionals are labeled as samples and confidence is coverage-weighted. Only integrity-passing observations with sufficient sampled-volume coverage may influence Tape rank/regime. Legacy/IEX/impossible-volume evidence remains withheld.  
