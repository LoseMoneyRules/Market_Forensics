...
**0.3.4 release status:** implementation complete on branch; branch CI #1827 / run `35751567572` SUCCESS at `b62b0c3cf61e9534931b053b9ff9ef8d5ea0fcc8`, including release metadata, Python/YAML/JavaScript checks, full pytest, production-minimal startup + rich-report smoke and self-contained reporting-vendor smoke. Production remains 0.3.3 until PR CI, merge, post-merge CI and a separate manual deploy succeed.  
