...
**0.3.3 field-resolution rule:** no symbol-specific financial parser exceptions. The common resolver uses canonical tags, exact semantic labels, conservative accounting algebra, same-date FY/Q4 instant bridges and optional secondary-provider fallback in that order. Operating Income may be derived from Gross Profit and true Operating Expenses; SGA may stand in for total Operating Expenses only when the candidate independently reconciles to pretax/non-operating evidence.  
