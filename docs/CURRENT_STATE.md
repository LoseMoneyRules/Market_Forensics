...
**0.3.3 pull request:** #64 `0.3.3: Core financial data recovery`; branch head before PR metadata sync `b979d94ee50fb095ab723d277262815b815397ba`.  
**0.3.3 branch verification:** CI #1714 / run `35728675722` SUCCESS at `b979d94ee50fb095ab723d277262815b815397ba`; release metadata, Python/YAML/JS checks, full pytest, production-minimal startup + rich-report smoke and self-contained reporting-vendor smoke all passed. PR/post-merge/deploy gates remain pending until they actually complete.  
