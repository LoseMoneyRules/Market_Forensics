...
**0.3.4 release status:** implementation branch in verification. Production remains 0.3.3 until PR CI, merge, post-merge CI and a separate manual deploy succeed.  
