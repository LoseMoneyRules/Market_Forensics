...
def financial_metrics(current: dict[str, Any], previous: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    metrics["lease_cost_to_revenue_pct"] = economic_metric(economic, "lease_cost_to_revenue_pct")
    metrics["operating_lease_current_share_pct"] = economic_metric(economic, "operating_lease_current_share_pct")
    metrics["operating_lease_current_to_cfo_x"] = economic_metric(economic, "operating_lease_current_to_cfo_x")
    metrics["interest_coverage_x"] = economic_metric(economic, "interest_coverage_x")
    metrics["fixed_charge_coverage_proxy_x"] = economic_metric(economic, "fixed_charge_coverage_proxy_x")
    metrics["rd_to_revenue_pct"] = economic_metric(economic, "rd_to_revenue_pct")
