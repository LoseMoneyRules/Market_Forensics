(() => {
  ...
  // Theme is a single runtime concern. The tiny legacy theme.js wrapper was folded
  // into the canonical app controller; the head bootstrap in base.html still
  ...
  // Mobile research-step selector. Markup is server-rendered; JavaScript only
  // owns interaction state, so navigation remains complete without DOM repair.
