...
def company_section(ticker, section):
    ...
    if section == "expectations":
        ...
        # Normal GET navigation serves only the materialized Tape cache.
        # Missing/legacy cache schemas are invalidated in research_cache.py and
        # rebuilt by the background RECALCULATE job queued by _ctx().
