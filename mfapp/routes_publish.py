...
def queue_refresh(ticker, kind):
    ...
    if kind == "positioning":
        # Tape charts and Tape Engine scoring share the stored HistoricalPrice
        # spine. A single Tape refresh must therefore repair that dependency too;
        # users should never have to discover a separate Historical Test action.
        enqueue_job(
