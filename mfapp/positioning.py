...
FLOW_METHOD_VERSION = "0.3.5-reconciled-observation-v2"
...
def _aggregate_trade_flow(day: date, sample: dict[str, Any]) -> dict[str, Any]:
    ...
    if observation_usable:
        # Low direction-eligible coverage is a scoring limitation, not evidence
        # corruption. Keep the reconciled observation visible in Tape/graphs while
        # preventing it from driving rank/regime.
